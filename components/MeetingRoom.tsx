  ...
  return (
    <section className="relative h-screen w-full overflow-hidden pt-4 text-white">
      <div className="relative flex size-full items-center justify-center">
        ...
        {/* Participants Panel */}
        <div
          className={cn('h-[calc(100vh-86px)] hidden ml-2 w-[320px] bg-dark-1 p-2 rounded-lg transition-all', { // Added base styles
        ...
        >
          {chatClient && meetingId && ( // Ensure client and ID are available
      ...
      <div className="fixed bottom-0 flex w-full items-center justify-center gap-5 py-2 bg-dark-1/80"> {/* Added padding and background */}
